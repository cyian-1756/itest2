...
minetest.register_node("itest2:iron_furnace", furnace_properties)
local active_furnace= {
	drop = "itest2:iron_furnace",
...
minetest.register_node("itest2:iron_furnace_active", active_furnace)

minetest.register_abm({
	nodenames = {"itest2:iron_furnace","itest2:iron_furnace_active"},
	interval = 1.0,
	chance = 1,
	action = function(pos, node, active_object_count, active_object_count_wider)
		...
		if state then
			minetest.swap_node(pos,"itest2:iron_furnace_active")
		else
			minetest.swap_node(pos,"itest2:iron_furnace")
		end
		meta:set_string("formspec", iron_furnace.get_formspec(pos))
	end,
})
