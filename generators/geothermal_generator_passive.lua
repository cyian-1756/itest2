minetest.register_node("itest2:geothermal_generator_passive",
...
tech_api.energy.register_device("itest2:geothermal_generator_passive", "default", {
    type = 'provider',
    max_rate = 25,
    ...
    callback = function(pos, dtime, request)
        ...
        local produce = math.min(prod, 50)
