...
for xm = 0, 1 do
    ...
    tech_api.energy.register_transporter(name.."_"..tname, {
      class = 'default',
      callback = function(new_connected_faces)
        -- will be used to report connected faces changes, to allow for
        -- texture/model update of the node
      end
    })
...
register_cables("itest2:copper_cable","copper cable",1,32,{0.3, 0.2},{4/16, 6/16},
    {"itest_copper_cable_0.png","itest_copper_cable_1.png"},
    {"itest_copper_cable_inv_0.png","itest_copper_cable_inv_1.png"})

register_cables("itest2:gold_cable","gold cable",2,128,{0.5, 0.45, 0.4},{4/16, 5/16, 6/16},
...
register_cables("itest2:tin_cable","tin cable",0,5,{0.025},{5/16},
    {"itest_tin_cable_0.png"},
    {"itest_tin_cable_inv_0.png"})

register_cables("itest2:hv_cable","HV cable",3,2048,{1, 0.95, 0.9, 0.8},{6/16, 8/16, 10/16, 12/16},
...
register_cable("itest2:glass_fiber_cable",512,0.025,"Glass fiber cable",4/16,gf_texture,gf_texture, gf_texture,"itest_glass_fiber_cable_inv.png")
